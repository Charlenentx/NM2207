...
library(jsonlite)
library(tidyverse)
historic_state_data_url <- "https://api.covidactnow.org/v2/states.timeseries.json?apiKey=d6ced5e2cf8244b3b28dd8c07305d858"
...
s",y="Recovered (%)")+theme_bw()

ggplot(data, aes(x=state,y=(data$actuals$vaccinationsCompleted/population))) + geom_bar(stat="identity") + labs(x="State
s",y="Vaccinated (%)")+theme_bw()
