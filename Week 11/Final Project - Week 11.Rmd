---
title: "Final Project Submission - Week 11"
author: "Chee Ting"
date: "2023-10-16"
...
- Drop-down menu that allow users to choose the countries that they want to plot.
...
- Drop-down menu that allow users to choose the type of goods that they want to plot.
- Slider to allow the user to choose the year interval
