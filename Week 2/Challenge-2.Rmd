...
**Solution:** CSV stands for comma-separated values file. It is a simple and universal format that can be easily read and written by many programs and tools, such as Python, R, SQL, and even text editors.
<br>
<br>
...
```
<br>
```{r, out.height= "400px",out.width= "800px",echo=FALSE,eval=TRUE,fig.cap="Information of read_csv"}
knitr::include_graphics("C:/Users/Cheeting/OneDrive/Pictures/Screenshots/NM2207 Week 2 read_csv.png")
```
<br>

**Question 1.6:** What does the `skip` argument in the read_csv() function do?

**Solution:** It is used to skip a row in a CSV file
<br>
<br>
...
geom_point(shape = 3) # <-- Hint: Use ? to learn more about geom_point and use appropriate values for shape
...
labs(x="Age",y="Rating", title="Ratings versus Age", caption="Source: playlist_data")+
